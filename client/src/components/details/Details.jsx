...
console.log(details)
    ...
    return(
        <div className="details">
             ...
             <div>
            <img alt="img" width="200px"height="150px" src= {details.length? details[0].image:"Imagen no encontrada"}/>
            <h2>Nombre: { details.length? details[0].name: "Cargando"}</h2>
            <h3>Temperamentos:</h3>
            {
                details[0].temp?.map((e)=>{
            ...
            {details[0].created? <button onClick={handleDelete}>Borrar</button>: " "}
            </div>  
            </div>
